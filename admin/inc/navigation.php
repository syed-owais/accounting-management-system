            ...
            <div class="os-viewport os-viewport-native-scrollbars-invisible" style="overflow-y: scroll;">
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="">
                   ...
                   <li class="nav-item">
                       <a href="<?php echo base_url ?>admin/?page=inventory/purchase" class="nav-link text-light nav-inventory_purchase">
                   ...
                   <li class="nav-item">
                       <a href="<?php echo base_url ?>admin/?page=inventory/sales" class="nav-link text-light nav-inventory_sales">
                   ...
                   <li class="nav-item">
                       <a href="<?php echo base_url ?>admin/?page=inventory/products/list" class="nav-link text-light nav-inventory_products_list">
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=reports/owners_equity" class="nav-link text-light nav-reports_owners_equity">
                        <i class="nav-icon fas fa-file"></i>
                        <p>
                          Owner's Equity
                        </p>
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=vendor" class="nav-link text-light nav-vendor_list">
                        <i class="nav-icon fas fa-users-cog"></i>
                        <p>
                          Vendor List
                        </p>
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=customer" class="nav-link text-light nav-customer_list">
                        <i class="nav-icon fas fa-users-cog"></i>
                        <p>
                          Customer List
                        </p>
